...
Notice that each of these options corresponds to a function on the Laravel [auto-loader](/docs/laravel/loading). In fact, the value of the option will automatically be passed to the corresponding function on the auto-loader.
...
Refer to the documentation on [bundle routing](/docs/laravel/routing#bundle-routes) and [bundle controllers](/docs/laravel/controllers#bundle-controllers) for more information on routing and bundles.
...
For more information on conveniently getting the path to your bundle assets once they are in the public directory, refer to the documentation on [asset management](/docs/laravel/views/assets#bundle-assets).
