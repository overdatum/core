...
The default connection will always be used by the [fluent query builder](/docs/laravel/database/fluent). If you need to change the default connection during a request, use the **Config::set** method.