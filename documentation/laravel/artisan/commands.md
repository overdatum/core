...
## Application Configuration <small>[(More Information)](/docs/laravel/install#basic-configuration)</small>
...
<a name="sessions"></a>
## Database Sessions <small>[(More Information)](/docs/laravel/session/config#database)</small>
...
<a name="migrations"></a>
## Migrations <small>[(More Information)](/docs/laravel/database/migrations)</small>
...
<a name="bundles"></a>
## Bundles <small>[(More Information)](/docs/laravel/bundles)</small>
...
<a name="tasks"></a>
## Tasks <small>[(More Information)](/docs/laravel/artisan/tasks)</small>
...
<a name="unit-tests"></a>
## Unit Tests <small>[(More Information)](/docs/laravel/testing)</small>
...
<a name="routing"></a>
## Routing <small>[(More Information)](/docs/laravel/routing)</small>
